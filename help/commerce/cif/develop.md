...
>[!NOTE]
>
>下列指示可協助您使用CIF設定適用於AEM Commerce的本機AEM開發環境，並著重於AEM 6.5 LTS)。 如果您使用AEM as a Cloud Service，請參閱[AEM Commerce as a Cloud Service](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/content-and-commerce/introduction#)檔案。
