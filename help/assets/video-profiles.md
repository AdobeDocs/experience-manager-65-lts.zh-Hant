...
視訊智慧型裁切 — 「視訊描述檔」中提供的選用功能 — 是利用Adobe AI中人工智慧的強大功能的工具。 它會自動偵測並裁切您上傳之任何最適化視訊或漸進式視訊中的焦點，無論大小。
...
Adobe AI限製為9000個畫面。 也就是說，30 FPS時需要5分鐘。 如果您的視訊具有較高的FPS，則支援的最大視訊持續時間會減少。 例如，Adobe AI和智慧型裁切只有在長度至少為二分半鐘時，才支援60 FPS視訊。
...
1. 在「視訊編碼預設集」標題下，新增、編輯或刪除組成設定檔的視訊編碼預設集。
   ...
   選取&#x200B;**[!UICONTROL 基本]**&#x200B;和&#x200B;**[!UICONTROL 進階]**&#x200B;標籤上每個選項旁的資訊圖示。 您可以閱讀其他說明，或根據選取的視訊格式轉碼器建議的設定。
