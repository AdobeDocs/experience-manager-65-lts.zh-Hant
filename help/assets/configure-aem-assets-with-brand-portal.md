...
下載AEM之後，如需設定AEM Author執行個體的指示，請參閱[部署和維護](https://experienceleague.adobe.com/docs/experience-manager-65-lts/deploying/deploying/deploy.html#default-local-install)。
