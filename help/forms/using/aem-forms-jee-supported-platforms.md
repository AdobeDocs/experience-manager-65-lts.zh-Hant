...
- **完整安裝程式的升級支援**：僅從AEM 6.5.23.0開始支援完整安裝程式的升級。
...
<table>
 <tbody>
  <tr>
   ...
   <tr> 
   <td><p>Oracle Java™ SE 21 （64位元） <sup> [8] </sup> </p>  </td>
   <td><p>A：支援</p> </td>
   <td><p>次要版本和更新 </p> </td>
  </tr>
  <tr> 
...
<table>
 <tbody>
  ...
  <tr>
   <td><p>WebSphere® Liberty設定檔(WLP)</p> </td>
   <td><p>A：支援</p> </td>
...
>[!NOTE]
>
>WebSphere® Liberty Profile (WLP)僅支援Oracle Database或Microsoft® SQL Server，以及IBM® Sumeru JDK 21。
...
1. JEE上的AEM Forms僅支援WebSphere® Liberty Profile (WLP)搭配Oracle Database或Microsoft® SQL Server和IBM®Sumeru JDK 21。
...
>[!NOTE]
>
>Acrobat DC產品系列為Acrobat和Reader引入兩種路徑，它們是不同的產品：「Classic」和「Continuous」。
...
>- Workspace在Macintosh OS X 10.6和10.7上支援Safari 5.1 （含Acrobat DC或更新版本）。
>- Safari不支援管理主控台。
...
有時候，Adobe不支援變更主要功能的第三方更新，因此也不支援完整的回溯相容性。
...
- 6.5 LTS SP3 （2026年9月）
  - **新增支援**：除了Oracle資料庫之外，Microsoft® SQL Server現在也支援WebSphere® Liberty設定檔(WLP)。
