...
請參閱[AEM 6.5 Forms Service Pack安裝指示](https://experienceleague.adobe.com/docs/experience-manager-65-2025/release-notes/aem-forms-current-service-pack-installation-instructions.html)文章，安裝JEE環境適用的最新Service Pack。
