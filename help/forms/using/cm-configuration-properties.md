---
title: 通訊管理設定屬性
description: 本主題說明如何使用解決方案特定的設定來編輯Asset Composer。
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p>在應用程式中啟用PDF的醒目提示。</p> </td>
   <td><p>true</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>目標反白顯示型別</p> </td>
   <td><p>應用程式中的目標反白顯示型別。</p> </td>
   <td><p>邊框</p> </td>
   <td><p>邊框/填滿/無</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><p>從發佈程式傳送之重新導向URL的引數名稱。 此值可以是任何字串變數名稱。</p> </td>
  ...
  <tr>
   <td><p>最佳化資料字典例項</p> </td>
   <td><p>啟用最佳化資料字典例項(b/w)伺服器和使用者端的傳輸。</p> </td>
   <td><p>true</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>自動更正不一致 </p> </td>
   <td><p>啟用時，它會自動處理信件指派中可能的不一致。</p> </td>
   <td><p>true</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   <td><p>資料編輯格式</p> </td>
   <td><p>編輯資料格式。 將資料寫入為String或從String剖析資料時使用。</p> </td>
   <td><p>locale=en_US； dateFormat=dd-MM-yyyy； numberDecimalSeparator=.； numberGroupSeparator=，； numberUseGroupSeparator=true</p> </td>
   <td>--<p> </p> </td>
  </tr>
  <tr>
   <td><p>管理發布時的信件例項</p> </td>
   <td><p>啟用/停用字母功能（僅適用於發佈伺服器）。</p> </td>
   <td><p>false</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>啟用稽核</p> </td>
   <td><p>啟用/停用稽核功能。 為false時，會停用所有動作的稽核記錄。</p> </td>
   <td><p>false</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   <td><p>附件檔案引數名稱</p> </td>
   <td><p>傳送到張貼程式的附件檔案的引數名稱。</p> </td>
   <td><p>inAttachmentDocs</p> </td>
   <td><p>任何字串變數名稱</p> </td>
  </tr>
  <tr>
   <td><p>CM使用者根目錄</p> </td>
   <td><p>包含所有「通訊管理」使用者資產的資料夾的URL。</p> </td>
   <td><p>--</p> </td>
   <td><p>有效的資料夾位置</p> </td>
  </tr>
  <tr>
   <td><p>字母快取大小</p> </td>
   <td><p>指定快取中要保留的最大字母數。</p> <p>變更此值會清除<code>in-memory</code>快取。</p> </td>
   <td><p>100</p> </td>
   <td><p>任何數值</p> </td>
  </tr>
  <tr>
   <td><p>啟用字母快取</p> </td>
   <td><p>啟用/停用字母快取。</p> <p>變更此值會清除<code>in-memory </code>快取。</p> </td>
   <td><p>true</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>資料元素順序</p> </td>
   <td><p>讓資料元素在介面中按照其在Letter中的順序排序。</p> </td>
   <td><p>true</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>支援重新載入</p> </td>
   <td><p>啟用/停用伺服器端轉譯字母中的重新載入支援。</p> <p>停用可改善字母轉譯效能。</p> </td>
   <td><p>false</p> </td>
  ...
  <tr>
   <td>相容性選項</td>
   <td>格式configname的相容性選項：以逗號分隔的configvalue。</td>
   <td>acm.compatibilityOptions</td>
   <td> </td>
  </tr>
  <tr>
   <td><p>偵錯目錄 </p> <p> </p> </td>
   <td>用於偵錯的檔案系統資料夾位置。 如果目錄沒有<code>exists</code>，則不會產生偵錯傾印。</td>
