...
在OSGi[&#128279;](/help/forms/using/aem-forms-workflow.md)上指派工作和以Forms為中心的工作流程的Adobe Sign步驟，可提供動態選取使用者的選項。 您可以使用ECMAScript或OSGi套件組合來動態選取「指派工作」步驟的被指定者，或選取「簽署檔案」步驟的簽署者。
