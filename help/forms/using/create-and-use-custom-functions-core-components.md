...
您可以使用AEM專案原型[，將使用者端程式庫新增至已建立的專案](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-core-components/using/developing/archetype/using#getting-started)，以新增自訂函式。
