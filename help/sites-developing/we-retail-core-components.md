---
title: 請試用We.Retail中的核心元件
description: 瞭解如何使用We.Retail在Adobe Experience Manager中使用核心元件。
contentOwner: User
...
1. 以`We.Retail`範例內容啟動Adobe Experience Manager (AEM)，並開啟[元件主控台](/help/sites-authoring/default-components-console.md)。
...
1. 所有核心元件都使用&#x200B;**v1**&#x200B;名稱來表示每個元件的第一個版本。 已規劃在未來發行的定期版本，此版本與AEM版本相容，可讓您輕鬆升級，以便利用最新功能。
1. 按一下&#x200B;**文字(v1)**。
...
1. 核心元件可讓範本作者設定哪些屬性可供頁面作者使用。 這些屬性包括如允許的貼上來源、格式選項和可用段落樣式等功能。

   這類設計對話方塊可用於許多核心元件，並可與範本編輯器搭配使用。 在啟用後，作者可以透過元件編輯器使用它們。
