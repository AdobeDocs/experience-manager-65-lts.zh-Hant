---
title: Adobe Content Package Maven外掛程式
...
# Adobe Content Package Maven外掛程式 {#adobe-content-package-maven-plugin}

使用Adobe Content Package Maven外掛程式，將套件部署和管理工作整合到您的Maven專案中。

Adobe Content Package Maven外掛程式會將建構的套件部署至AEM，並將您通常在AEM Package Manager中執行的作業自動化。
