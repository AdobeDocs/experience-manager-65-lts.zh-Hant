---
title: 使用 Sling 介面卡
description: Sling提供Adapter模式，可方便地翻譯實作Adaptable介面的物件。
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>當檔案資源為JCR節點型（<code>nt:file</code>或<code>nt:resource</code>）、組合資源或檔案系統資源時，它會傳回檔案資源的二進位內容。 它會傳回二進位JCR屬性資源的資料。</td>
  </tr>
  <tr>
   <td><a href="https://docs.oracle.com/javase/1.5.0/docs/api/java/net/URL.html">URL</a></td>
   <td>它會傳回資源的URL。 它會傳回JCR節點型資源的存放庫URL、組合資源的JAR組合URL或檔案系統資源的檔案URL。</td>
  </tr>
  <tr>
