...
source-git-commit: dad4432ae3fba61d7058d00edcf2c9ad379202f5
workflow-type: tm+mt
...
* Oracle Java™ 17/21 （64位元） (如需更多詳細資料，請參閱[Java支援](#java-support)區段的更多詳細資料。
...
### 離線壓縮後線上壓縮期間存放庫損毀(GRANITE-65146)
...
在套用執行個體停機時間時進行規劃。 若要進行離線壓縮，請使用對應的[Oak-run jar](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq660/hotfixes/oak-run-1.78.1-B006.jar) （也可在Software Distribution上取得）。

>[!NOTE]
>
> 對於任何Oak-run作業，請使用[Oak-run 1.78.1-B006 jar](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq660/hotfixes/oak-run-1.78.1-B006.jar) （以上連結）。
