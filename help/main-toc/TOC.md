    ...
    + Headless 體驗管理 {#headless}
      ...
      + Headless 歷程 {#journeys}
        + Headless 開發人員歷程 {#developer}
          ...
          + [如何透過 AEM 傳遞 API 存取您的內容](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/access-your-content.html)
          ...
          + [如何讓您的無周邊應用程式上線](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/go-live.html)
      ...
      + 內容片段{#content-fragments}
        ...
        + [預覽 - JSON 表示法](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-json-preview.html)
      + 傳送API{#delivery-api}
