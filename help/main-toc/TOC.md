...
+ Sites {#sites}
   + 製作 {#authoring}
      ...
      + 頁面效能 {#page-performance}
         + [內容洞察](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/sites/authoring/siteandpage/content-insights.html)
   ...
   + 管理 {#administering}
      ...
      + 個人化 {#personalization}
         ...
         + [設定 ContextHub](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/personlization/ch-configuring.html)
      ...
      + 最佳做法 {#bestpractices}
         ...
         + [翻譯最佳做法](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/sites/administering/introduction/tc-bp.html)
         ...
         + [處理AEM Foundation的GDPR請求](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/security/handling-gdpr-requests-for-aem-platform.html)
...
+ Forms {#forms}
   ...
   + 管理AEM Forms {#manage-administer-aem-forms}
      ...
      + 強化AEM Forms環境 {#hardening-aem-forms-environment}
         ...
         + {hide-from-toc}[JEE版AEM Forms的一般安全性考量事項](/help/forms/using/general-security-considerations.md)
         + {hide-from-toc}[在JEE環境中強化您的AEM Forms](/help/forms/using/hardening-aem-forms-jee-environment.md)
         + {hide-from-toc}[在JEE上設定AEM Forms的安全管理設定](/help/forms/using/configuring-secure-administration-settings-aem.md)
   ...
   + 工作流程 {#workflows}
      ...
      + {hide-from-toc}[在OSGi和AEM Forms JEE工作流程中，表單中心AEM工作流程的動作和功能](/help/forms/using/capabilities-osgi-jee-workflows.md)
   ...
   + AEM Forms應用程式 {#aem-forms-app}
      ...
      + [設定™ studio專案並建置Android™應用程式](/help/forms/using/setup-android-studio-project-build-installer.md)
      + [建置AEM Forms Android™應用程式](/help/forms/using/setup-eclipse-project-build-installer.md)
   ...
   + JEE上AEM Forms的管理員說明 {#administrator-help}
      + 開始使用 {#get-started}
         + {hide-from-toc}[一般AEM Forms設定](/help/forms/using/admin-help/configure-general-aem-forms-settings.md)
         + {hide-from-toc}[更新部署的授權型別](/help/forms/using/admin-help/update-license-type-deployment.md)
      + 設定和管理網域 {#setup-manage-domains}
         + {hide-from-toc}[正在新增網域](/help/forms/using/admin-help/adding-domains.md)
         + {hide-from-toc}[刪除網域](/help/forms/using/admin-help/delete-domain.md)
         + {hide-from-toc}[設定帳戶鎖定設定](/help/forms/using/admin-help/configure-account-locking-settings.md)
         + {hide-from-toc}[編輯和轉換現有的網域](/help/forms/using/admin-help/editing-converting-existing-domains.md)
         + {hide-from-toc}[正在設定驗證服務提供者](/help/forms/using/admin-help/configuring-authentication-providers.md)
         + {hide-from-toc}[正在同步處理目錄](/help/forms/using/admin-help/synchronizing-directories.md)
         + {hide-from-toc}[正在設定目錄](/help/forms/using/admin-help/configuring-directories.md)
      + 設定使用者管理 {#configure-user-management}
         + {hide-from-toc}[變更驗證的評估順序](/help/forms/using/admin-help/change-order-evaluation-authentication.md)
         + {hide-from-toc}[設定LDAP繫結密碼](/help/forms/using/admin-help/configure-ldap-bind-password.md)
         + {hide-from-toc}[設定AEM表單以預先擷取網域資訊](/help/forms/using/admin-help/configure-aem-forms-prefetch-domain.md)
         + {hide-from-toc}[設定憑證式驗證](/help/forms/using/admin-help/configuring-certificate-based-authentication.md)
         + {hide-from-toc}[設定SAML服務提供者設定](/help/forms/using/admin-help/configure-saml-service-provider-settings.md)
         + {hide-from-toc}[在AEM表單中啟用單一登入](/help/forms/using/admin-help/enabling-single-sign-on-aem.md)
         + {hide-from-toc}[設定啟用SSL之LDAP伺服器的使用者管理](/help/forms/using/admin-help/configure-user-management-ssl-enabled.md)
         + {hide-from-toc}[匯入和匯出組態檔](/help/forms/using/admin-help/importing-exporting-configuration-file.md)
         + {hide-from-toc}[設定進階系統屬性](/help/forms/using/admin-help/configure-advanced-system-attributes.md)
         + {hide-from-toc}[防止CSRF攻擊](/help/forms/using/admin-help/preventing-csrf-attacks.md)
      + 設定和組織使用者 {#setup-organize-users}
         + {hide-from-toc}[正在新增及設定使用者](/help/forms/using/admin-help/adding-configuring-users.md)
         + {hide-from-toc}[即時使用者布建](/help/forms/using/admin-help/just-in-time-user-provisioning.md)
         + {hide-from-toc}[正在建立和設定群組](/help/forms/using/admin-help/creating-configuring-groups.md)
         + {hide-from-toc}[搜尋使用者或群組](/help/forms/using/admin-help/search-user-or-group.md)
         + {hide-from-toc}[正在建立和設定角色](/help/forms/using/admin-help/creating-configuring-roles.md)
      + 連線到內容管理系統 {#connect-content-management-system}
         + {hide-from-toc}[設定EMC Documentum的聯結器®](/help/forms/using/admin-help/configuring-connector-emc-documentum.md)
         + {hide-from-toc}[正在設定® FileNet的聯結器](/help/forms/using/admin-help/configuring-connector-ibm-filenet.md)
         + {hide-from-toc}[設定®內容管理員的聯結器](/help/forms/using/admin-help/configuring-connector-ibm-content-manager.md)
         + {hide-from-toc}[設定Microsoft SharePoint的聯結器](/help/forms/using/admin-help/configuring-connector-microsoft-sharepoint.md)
      + 管理憑證和認證 {#manage-certificates-credentials}
         + {hide-from-toc}[正在新增及移除使用者名稱和密碼認證](/help/forms/using/admin-help/adding-removing-user-name-password.md)
         + {hide-from-toc}[管理憑證撤銷清單](/help/forms/using/admin-help/certificate-revocation-lists.md)
         + {hide-from-toc}[管理憑證和認證的基本知識](/help/forms/using/admin-help/overview-2.md)
         + {hide-from-toc}[管理憑證](/help/forms/using/admin-help/certificates.md)
         + {hide-from-toc}[管理HSM認證](/help/forms/using/admin-help/hsm-credentials.md)
         + {hide-from-toc}[管理本機認證](/help/forms/using/admin-help/local-credentials.md)
      + 匯入及管理應用程式和封存 {#import-manage-applications-archives}
         + {hide-from-toc}[變更應用程式和服務頁面上顯示的專案數](/help/forms/using/admin-help/change-number-items-displayed-applications.md)
         + {hide-from-toc}[匯入及管理封存](/help/forms/using/admin-help/import-archives.md)
         + {hide-from-toc}[匯入及管理應用程式](/help/forms/using/admin-help/import-applications.md)
      + 管理服務 {#manage-services}
         + {hide-from-toc}[設定服務設定](/help/forms/using/admin-help/configure-service-settings.md)
         + {hide-from-toc}[正在啟動及停止服務](/help/forms/using/admin-help/starting-stopping-services.md)
      + 管理端點 {#manage-endpoints}
         + {hide-from-toc}[新增、啟用、修改或移除端點](/help/forms/using/admin-help/adding-enabling-modifying-or-removing.md)
         + {hide-from-toc}[設定電子郵件端點](/help/forms/using/admin-help/configuring-email-endpoints.md)
         + {hide-from-toc}[設定oAuth2.0驗證](/help/forms/using/oauth2-support-for-mail-service.md)
         + {hide-from-toc}[設定遠端端點](/help/forms/using/admin-help/configuring-remoting-endpoints.md)
         + {hide-from-toc}[正在設定watched資料夾端點](/help/forms/using/admin-help/configuring-watched-folder-endpoints.md)
         + {hide-from-toc}[設定工作管理員端點](/help/forms/using/admin-help/configuring-task-manager-endpoints.md)
         + {hide-from-toc}[端點型別](/help/forms/using/admin-help/types-endpoints.md)
      + 設定Acrobat Reader DC延伸模組 {#configure-acrobat-reader-dc-extensions}
         + {hide-from-toc}[Acrobat Reader DC Extensions使用的憑證型別](/help/forms/using/admin-help/certificate-types-used-acrobat-reader.md)
         + {hide-from-toc}[在PDF檔案中辨識有效及過期的憑證](/help/forms/using/admin-help/recognizing-valid-expired-certificates-pdf.md)
         + {hide-from-toc}[設定Acrobat Reader DC延伸模組以進行資料擷取](/help/forms/using/admin-help/configuring-acrobat-reader-dc-extensions.md)
         + {hide-from-toc}[檢閱認證使用資訊](/help/forms/using/admin-help/review-credential-information.md)
         + {hide-from-toc}[設定認證以搭配Acrobat Reader DC擴充功能使用](/help/forms/using/admin-help/configuring-credentials-acrobat-reader-dc.md)
         + {hide-from-toc}[檢閱PDF檔案的使用許可權](/help/forms/using/admin-help/review-usage-rights-pdf-file.md)
         + {hide-from-toc}[啟用Adobe Reader網頁瀏覽器外掛程式的線上註解](/help/forms/using/admin-help/enabling-online-commenting-reader-web.md)
         + {hide-from-toc}[設定與Acrobat Reader DC擴充功能搭配使用的逾時值](/help/forms/using/admin-help/setting-timeout-values-acrobat-reader.md)
         + {hide-from-toc}[正在更新過期的Reader延伸模組服務憑證](/help/forms/using/admin-help/updating-expired-reader-extension-certificates.md)
      + 使用PDF Generator {#work-with-pdf-generator}
         + {hide-from-toc}[使用PDF Generator簡介](/help/forms/using/admin-help/overview-5.md)
         + {hide-from-toc}[啟用多執行緒檔案轉換](/help/forms/using/admin-help/enabling-multi-threaded-file-conversions.md)
         + {hide-from-toc}[正在設定Adobe PDF設定](/help/forms/using/admin-help/configuring-pdf-settings.md)
         + {hide-from-toc}[正在設定安全性設定](/help/forms/using/admin-help/configuring-security-settings.md)
         + {hide-from-toc}[正在設定檔案型別設定](/help/forms/using/admin-help/configuring-file-type-settings.md)
         + {hide-from-toc}[匯入和匯出PDF Generator組態檔](/help/forms/using/admin-help/importing-exporting-pdf-generator-configuration.md)
         + {hide-from-toc}[啟用PDF/A支援](/help/forms/using/admin-help/enable-pdf-a-support.md)
         + {hide-from-toc}[正在設定PDFG網路印表機（僅限Windows）](/help/forms/using/admin-help/setting-pdfg-network-printer-windows.md)
         + {hide-from-toc}[設定遞補字型](/help/forms/using/admin-help/configuring-fallback-fonts.md)
         + {hide-from-toc}[修改PDF匯出轉換設定](/help/forms/using/admin-help/modifying-pdf-export-conversion-settings.md)
         + {hide-from-toc}[使用PDF Generator轉換檔案](/help/forms/using/admin-help/converting-files-using-pdf-generator.md)
      + 設定SSL {#configure-ssl}
         + {hide-from-toc}[設定SSL的總覽](/help/forms/using/admin-help/overview-6.md)
         + [為JBoss®應用程式伺服器設定SSL](/help/forms/using/admin-help/configuring-ssl-for-jboss-application-server-aem-forms-65-lts-jee.md)
         + {hide-from-toc}[在Windows Vista上設定SSL](/help/forms/using/admin-help/configuring-ssl-windows-vista.md)
         + {hide-from-toc}[為WebSphere®應用程式伺服器設定SSL](/help/forms/using/admin-help/configuring-ssl-websphere-application-server.md)
      + 使用Document Security {#work-with-document-security}
         + {hide-from-toc}[關於Document Security](/help/forms/using/admin-help/document-security.md)
         + {hide-from-toc}[大量安全資訊傳遞](/help/forms/using/admin-help/high-volume-secure-information-delivery.md)
         + {hide-from-toc}[正在設定使用者端和伺服器選項](/help/forms/using/admin-help/configuring-client-server-options.md)
         + {hide-from-toc}[管理受邀和本機使用者帳戶](/help/forms/using/admin-help/invited-local-user-accounts.md)
         + {hide-from-toc}[控制受原則保護檔案的存取權](/help/forms/using/admin-help/controlling-access-policy-protected-documents.md)
         + {hide-from-toc}[正在監視事件](/help/forms/using/admin-help/monitoring-events.md)
         + {hide-from-toc}[建立和管理原則](/help/forms/using/admin-help/creating-policies.md)
         + {hide-from-toc}[使用Document Security網頁](/help/forms/using/admin-help/using-document-security-web-pages.md)
         + {hide-from-toc}[正在建立和管理原則集](/help/forms/using/admin-help/creating-policy-sets.md)
         + {hide-from-toc}[註冊為使用者](/help/forms/using/admin-help/registering-as-a-user.md)
      + 設定Forms {#configure-forms}
         + {hide-from-toc}[設定表單的基本知識](/help/forms/using/admin-help/overview-7.md)
         + {hide-from-toc}[設定國際化選項](/help/forms/using/admin-help/setting-internationalization-options.md)
         + {hide-from-toc}[正在設定Forms的快取](/help/forms/using/admin-help/configuring-caching-forms.md)
         + {hide-from-toc}[正在指定XCI組態選項](/help/forms/using/admin-help/specifying-xci-configuration-options.md)
         + {hide-from-toc}[設定表單輸出](/help/forms/using/admin-help/configuring-form-output.md)
         + {hide-from-toc}[指定要內嵌的字型](/help/forms/using/admin-help/specifying-fonts-embed.md)
         + {hide-from-toc}[設定Forms的位置](/help/forms/using/admin-help/configuring-locations-forms.md)
         + {hide-from-toc}[正在指定安全性設定](/help/forms/using/admin-help/specifying-security-settings.md)
         + {hide-from-toc}[正在設定驗證訊息](/help/forms/using/admin-help/configuring-validation-messages.md)
      + 設定輸出 {#configure-output}
         + {hide-from-toc}[輸出服務總覽](/help/forms/using/admin-help/overview-8.md)
         + {hide-from-toc}[指定XCI組態選項](/help/forms/using/admin-help/specify-xci-configuration-options.md)
         + {hide-from-toc}[設定輸出的快取](/help/forms/using/admin-help/configuring-caching-output.md)
         + {hide-from-toc}[指定輸出的檔案位置](/help/forms/using/admin-help/specify-file-locations-output.md)
         + {hide-from-toc}[讓字型可用](/help/forms/using/admin-help/make-fonts-available.md)
         + {hide-from-toc}[指定要內嵌的字型](/help/forms/using/admin-help/specify-fonts-embed.md)
         + {hide-from-toc}[指定安全性設定](/help/forms/using/admin-help/specify-security-settings.md)
         + {hide-from-toc}[變更字元集](/help/forms/using/admin-help/change-character-set.md)
      + 設定Forms Workflow{#configure-forms-workflow}
         + {hide-from-toc}[關於管理與程式術語](/help/forms/using/admin-help/administration-process-terminology.md)
         + {hide-from-toc}[管理處理序](/help/forms/using/admin-help/processes.md)
         + {hide-from-toc}[設定商務行事曆](/help/forms/using/admin-help/configuring-business-calendars.md)
         + {hide-from-toc}[Forms Workflow概觀](/help/forms/using/admin-help/overview-9.md)
         + {hide-from-toc}[正在設定外出設定](/help/forms/using/admin-help/configuring-out-office-settings.md)
         + {hide-from-toc}[正在搜尋處理序執行個體](/help/forms/using/admin-help/searching-process-instances.md)
         + {hide-from-toc}[設定伺服器設定](/help/forms/using/admin-help/configuring-server-settings.md)
         + {hide-from-toc}[使用停止的操作和分支](/help/forms/using/admin-help/stalled-operations-branches.md)
         + {hide-from-toc}[設定共用佇列](/help/forms/using/admin-help/configuring-shared-queues.md)
         + {hide-from-toc}[處理任務](/help/forms/using/admin-help/tasks.md)
      + 設定Workspace {#configure-workspace}
         + {hide-from-toc}[Workspace概觀](/help/forms/using/admin-help/overview-10.md)
         + {hide-from-toc}[匯入和匯出全域設定](/help/forms/using/admin-help/importing-exporting-global-settings.md)
         + {hide-from-toc}[設定當天的訊息](/help/forms/using/admin-help/setting-message-day.md)
         + {hide-from-toc}[自訂搜尋範本](/help/forms/using/admin-help/customizing-search-templates.md)
         + {hide-from-toc}[管理Workspace中顯示的類別](/help/forms/using/admin-help/categories-displayed-workspace.md)
      + 健康狀態監視 {#health-monitor}
         + {hide-from-toc}[健康情況監視概觀](/help/forms/using/admin-help/overview-11.md)
      ...
      + 維護AEM表單 {#maintain-aem-forms}
         ...
         + {hide-from-toc}[監視AEM表單部署](/help/forms/using/admin-help/monitoring-aem-forms-deployments.md)
         + {hide-from-toc}[工作管理員和節流](/help/forms/using/admin-help/manager-throttling.md)
         + {hide-from-toc}[在維護模式下執行AEM表單](/help/forms/using/admin-help/running-aem-forms-maintenance-mode.md)
      + 維護AEM表單資料庫 {#maintain-aem-forms-database}
         + {hide-from-toc}[DB2®資料庫：每週執行處理序](/help/forms/using/admin-help/db2-database-running-process-weekly.md)
         + {hide-from-toc}[Oracle資料庫最大開啟游標臨界值](/help/forms/using/admin-help/oracle-database-maximum-open-cursors.md)
         + {hide-from-toc}[® DB2®資料庫：正在執行定期維護的命令](/help/forms/using/admin-help/ibm-db2-database-running-commands.md)
         + {hide-from-toc}[正在清除處理作業資料](/help/forms/using/admin-help/purging-process-data.md)
         + {hide-from-toc}[Microsoft SQL Server資料庫：微調組態](/help/forms/using/admin-help/microsoft-sql-server-database-fine.md)
         + {hide-from-toc}[將資料庫成長減至最低的秘訣](/help/forms/using/admin-help/tips-minimizing-database-growth.md)
      + 維護應用程式伺服器 {#manage-application-server}
         + {hide-from-toc}[應用程式伺服器網站](/help/forms/using/admin-help/application-server-websites.md)
         + {hide-from-toc}[全域檔案儲存目錄](/help/forms/using/admin-help/global-document-storage-directory.md)
         + {hide-from-toc}[執行AdministrationConsole時的考量事項](/help/forms/using/admin-help/considerations-running-administration-console.md)
         + {hide-from-toc}[增強應用程式伺服器效能](/help/forms/using/admin-help/enhancing-application-server-performance.md)
         + {hide-from-toc}[正在啟動及停止WebSphere®應用程式伺服器](/help/forms/using/admin-help/starting-stopping-websphere-application-server.md)
      + AEM Forms備份和復原 {#aem-forms-backup-recovery}
         + {hide-from-toc}[備份及復原EMC Documentum®存放庫](/help/forms/using/admin-help/backing-recovering-emc-documentum-repository.md)
         + {hide-from-toc}[正在啟用和停用安全備份模式](/help/forms/using/admin-help/enabling-disabling-safe-backup-mode.md)
         + {hide-from-toc}[正在備份AEM表單資料](/help/forms/using/admin-help/backing-aem-forms-data.md)
         + {hide-from-toc}[要備份和復原的檔案](/help/forms/using/admin-help/files-back-recover.md)
         + {hide-from-toc}[AEM表單的備份與復原策略](/help/forms/using/admin-help/backup-recovery-strategy-aem-forms.md)
         + {hide-from-toc}[PDF Generator備份限制](/help/forms/using/admin-help/pdf-generator-backup-limitations.md)
         + {hide-from-toc}[監視資料夾的備份策略](/help/forms/using/admin-help/backup-strategies-watched-folders.md)
         + [復原AEM表單資料](/help/forms/using/admin-help/recovering-aem-forms-data.md)
         + [EMC Documentum®使用者的Connector備份策略](/help/forms/using/admin-help/backup-strategy-connector-emc-documentum.md)
         + {hide-from-toc}[叢集環境中備份和還原的策略](/help/forms/using/admin-help/strategy-backup-restore-clustered-environment.md)
      + 系統資訊服務 {#system-information-service}
         + {hide-from-toc}[設定系統資訊服務](/help/forms/using/admin-help/set-system-information-service.md)
         + {hide-from-toc}[系統資訊服務API](/help/forms/using/admin-help/system-information-service-apis.md)
   + 程序報告 {#process-reporting}
      + {hide-from-toc}[程式報告簡介](/help/forms/using/process-reporting/introduction-process-reporting.md)
      + {hide-from-toc}[開始使用程式報告](/help/forms/using/process-reporting/install-start-process-reporting.md)
      + {hide-from-toc}[程式報告的運作方式](/help/forms/using/process-reporting/process-reporting-architecture.md)
      + {hide-from-toc}[處理序報告中的預先定義報告](/help/forms/using/process-reporting/pre-defined-reports-in-process-reporting.md)
      + {hide-from-toc}[處理中的自訂報告](/help/forms/using/process-reporting/process-reporting-custom-reports.md)
      + {hide-from-toc}[處理序報表中的特定查詢](/help/forms/using/process-reporting/adhoc-queries-in-process-reporting.md)
      + {hide-from-toc}[疑難排解程式報告](/help/forms/using/process-reporting/troubleshooting-process-management.md)
   + 開發人員參考資料 {#developer-reference}
      ...
      + 使用JEE上的AEM Forms進行程式設計 {#programming-aem-forms-jee}
         + 使用AEM Forms on JEE的程式設計簡介 {#introduction-programming-aem-forms-jee}
            + {hide-from-toc}[介紹Java API QuickStart](/help/forms/developing/introducing-java-api-soap-quick.md)
            + {hide-from-toc}[使用API叫用AEM Forms](/help/forms/developing/invoking-aem-forms-using-apis.md)
            + {hide-from-toc}[瞭解AEM Forms程式](/help/forms/developing/aem-forms-processes.md)
            + {hide-from-toc}[服務容器](/help/forms/developing/service-container.md)
         + 為AEM Forms開發SPI {#developing-spis-aem-forms}
            + {hide-from-toc}[正在建立邀請外部使用者處理常式](/help/forms/developing/creating-invite-external-users-handler.md)
         + Java API快速入門 — 程式碼範例 {#java-api-quick-start-code-examples}
            + {hide-from-toc}[應用程式管理員使用者端JavaAPI快速入門(SOAP)](/help/forms/developing/application-manager-client-java-api.md)
            + {hide-from-toc}[應用程式管理員服務JavaAPI快速入門(SOAP)](/help/forms/developing/application-manager-service-java-api.md)
            + {hide-from-toc}[組合器服務Java API快速入門(SOAP)](/help/forms/developing/assembler-service-java-api-quick.md)
            + {hide-from-toc}[Acrobat Reader DC Extensions Service Java API快速入門(SOAP)](/help/forms/developing/acrobat-reader-dc-extensions-service.md)
            + {hide-from-toc}[備份與還原服務APIQuick開始](/help/forms/developing/backup-restore-service-api-quick.md)
            + {hide-from-toc}[條碼式Forms服務Java APIQuick啟動(SOAP)](/help/forms/developing/barcoded-forms-service-java-api.md)
            + {hide-from-toc}[元件和服務Java APIQuick啟動(SOAP)](/help/forms/developing/components-services-java-api-quick.md)
            + {hide-from-toc}[轉換PDF服務Java API快速入門(SOAP)](/help/forms/developing/convert-pdf-service-java-api.md)
            + {hide-from-toc}[認證服務Java API快速入門(SOAP)](/help/forms/developing/credential-service-java-api-quick.md)
            + {hide-from-toc}[Distiller服務Java API快速入門(SOAP)](/help/forms/developing/distiller-service-java-api-quick.md)
            + {hide-from-toc}[DocConverter Service Java API快速入門(SOAP)](/help/forms/developing/docconverter-service-java-api-quick.md)
            + {hide-from-toc}[檔案管理服務（已棄用）Java API快速入門(SOAP)](/help/forms/developing/document-management-service-deprecated-java.md)
            + {hide-from-toc}[Document Security Service JavaAPI快速入門(SOAP)](/help/forms/developing/document-security-service-java-api.md)
            + {hide-from-toc}[加密服務Java API QuickStart(SOAP)](/help/forms/developing/encryption-service-java-api-quick.md)
            + {hide-from-toc}[端點登入Java API QuickStart(SOAP)](/help/forms/developing/endpoint-registry-java-api-quick.md)
            + {hide-from-toc}[表單資料整合服務JavaAPI快速入門(SOAP)](/help/forms/developing/form-data-integration-service-java.md)
            + {hide-from-toc}[Forms服務API快速啟動](/help/forms/developing/forms-service-api-quick-starts.md)
            + {hide-from-toc}[產生PDF服務Java API快速入門(SOAP)](/help/forms/developing/generate-pdf-service-java-api.md)
            + {hide-from-toc}[啟動API快速啟動](/help/forms/developing/invocation-api-quick-starts.md)
            + {hide-from-toc}[LiveCycleProcess Java API(SOAP)快速入門](/help/forms/developing/livecycleprocess-java-api-soap-quick.md)
            + {hide-from-toc}[輸出服務Java API快速入門(SOAP)](/help/forms/developing/output-service-java-api-quick.md)
            + {hide-from-toc}[PDF公用程式服務Java APIQuick啟動(SOAP)](/help/forms/developing/pdf-utilities-service-java-api.md)
            + {hide-from-toc}[儲存庫服務API快速啟動](/help/forms/developing/repository-service-api-quick-starts.md)
            + {hide-from-toc}[簽章服務Java API快速入門(SOAP)](/help/forms/developing/signature-service-java-api-quick.md)
            + {hide-from-toc}[工作管理員服務Java API快速入門(SOAP)](/help/forms/developing/task-manager-service-java-api.md)
            + {hide-from-toc}[使用者管理員Java API快速入門(SOAP)](/help/forms/developing/user-manager-java-api-quick.md)
            + {hide-from-toc}[XMP公用程式服務Java APIQuick啟動(SOAP)](/help/forms/developing/xmp-utilities-service-java-api.md)
         + 使用API在JEE上叫用AEM Forms {#invoking-aem-forms-jee-apis}
            + {hide-from-toc}[使用REST要求叫用AEM Forms](/help/forms/developing/invoking-aem-forms-using-rest.md)
            + {hide-from-toc}[使用Web服務叫用AEM Forms](/help/forms/developing/invoking-aem-forms-using-web.md)
            + {hide-from-toc}[使用遠端功能叫用AEM Forms](/help/forms/developing/invoking-aem-forms-using-remoting.md)
            + {hide-from-toc}[使用Web服務叫用AEM Forms](/help/forms/developing/invoking-human-centric-long-lived.md)
            + {hide-from-toc}[使用JavaAPI叫用AEM Forms](/help/forms/developing/invoking-aem-forms-using-java.md)
            + {hide-from-toc}[建立使用HTTP權杖執行SSO驗證的Flash Builder應用程式](/help/forms/developing/creating-flash-builder-applications-perform.md)
         + 使用API執行服務作業 {#performing-service-operations-using-apis}
            + {hide-from-toc}[使用API執行服務作業](/help/forms/developing/performing-service-operations-using-apis.md)
            + {hide-from-toc}[呈現Forms](/help/forms/developing/rendering-forms.md)
            + {hide-from-toc}[組裝PDF檔案](/help/forms/developing/assembling-pdf-documents.md)
            + {hide-from-toc}[以程式設計方式組合PDF檔案](/help/forms/developing/programmatically-assembling-pdf-documents.md)
            + {hide-from-toc}[在檔案格式和PDF之間轉換](/help/forms/developing/converting-file-formats-pdf.md)
            + {hide-from-toc}[以程式分解的PDF檔案](/help/forms/developing/programmatically-disassembling-pdf-documents.md)
            + {hide-from-toc}[組合加密的PDF檔案](/help/forms/developing/assembling-encrypted-pdf-documents.md)
            + {hide-from-toc}[組合多個XDP片段](/help/forms/developing/assembling-multiple-xdp-fragments.md)
            + {hide-from-toc}[使用Bates編號來組合檔案](/help/forms/developing/assembling-documents-using-bates-numbering.md)
            + {hide-from-toc}[組合非互動式PDF檔案](/help/forms/developing/assembling-non-interactive-pdf-documents.md)
            + {hide-from-toc}[使用書籤組裝PDF檔案](/help/forms/developing/assembling-pdf-documents-bookmarks.md)
            ...
            + {hide-from-toc}[動態建立DDX檔案](/help/forms/developing/dynamically-creating-ddx-documents.md)
            + {hide-from-toc}[處理已提交的Forms](/help/forms/developing/handling-submitted-forms.md)
            + {hide-from-toc}[最佳化Forms服務的效能](/help/forms/developing/optimizing-performance-forms-service.md)
            + {hide-from-toc}[傳遞檔案至FormsService](/help/forms/developing/passing-documents-forms-service.md)
            + {hide-from-toc}[使用可流動配置預先填入Forms](/help/forms/developing/prepopulating-forms-flowable-layouts.md)
            + {hide-from-toc}[根據片段呈現Forms](/help/forms/developing/rendering-forms-based-fragments.md)
            + {hide-from-toc}[依據值呈現Forms](/help/forms/developing/rendering-forms-value.md)
            + {hide-from-toc}[將Forms轉譯為HTML](/help/forms/developing/rendering-forms-html.md)
            + {hide-from-toc}[在使用者端轉譯Forms](/help/forms/developing/rendering-forms-client.md)
            + {hide-from-toc}[使用自訂CSS檔案轉譯HTML Forms](/help/forms/developing/rendering-html-forms-using-custom.md)
            + {hide-from-toc}[使用CustomToolbars呈現HTML Forms](/help/forms/developing/rendering-html-forms-custom-toolbars.md)
            + {hide-from-toc}[呈現互動式PDF forms](/help/forms/developing/rendering-interactive-pdf-forms.md)
            + {hide-from-toc}[轉譯啟用許可權的Forms](/help/forms/developing/rendering-rights-enabled-forms.md)
            + {hide-from-toc}[驗證DDX檔案](/help/forms/developing/validating-ddx-documents.md)
            + {hide-from-toc}[將PDF轉換為Postscript和Image檔案](/help/forms/developing/converting-pdf-postscript-image-files.md)
            + {hide-from-toc}[將Postscript轉換為PDF檔案](/help/forms/developing/converting-postscript-pdf-documents.md)
            + {hide-from-toc}[正在建立檔案輸出資料流](/help/forms/developing/creating-document-output-streams.md)
            + {hide-from-toc}[數位簽署和認證檔案](/help/forms/developing/digitally-signing-certifying-documents.md)
            + {hide-from-toc}[加密和解密PDF檔案](/help/forms/developing/encrypting-decrypting-pdf-documents.md)
            + {hide-from-toc}[匯入和匯出資料](/help/forms/developing/importing-exporting-data.md)
            + {hide-from-toc}[管理使用者](/help/forms/developing/users.md)
            + {hide-from-toc}[使用AEM Forms存放庫](/help/forms/developing/aem-forms-repository.md)
            + {hide-from-toc}[使用條碼式Forms](/help/forms/developing/barcoded-forms.md)
            + {hide-from-toc}[使用認證](/help/forms/developing/credentials.md)
            + {hide-from-toc}[使用PDF/A檔案](/help/forms/developing/pdf-a-documents.md)
            + {hide-from-toc}[使用PDF公用程式](/help/forms/developing/pdf-utilities.md)
            + {hide-from-toc}[使用XMP公用程式](/help/forms/developing/xmp-utilities.md)
            + {hide-from-toc}[正在準備AEM Forms以進行備份](/help/forms/developing/preparing-aem-forms-backup.md)
            + {hide-from-toc}[以程式設計方式管理端點](/help/forms/developing/programmatically-endpoints.md)
            + {hide-from-toc}[以程式設計方式管理喜好設定節點](/help/forms/developing/programmatically-preferences-nodes.md)
            + {hide-from-toc}[使用原則保護檔案](/help/forms/developing/protecting-documents-policies.md)
            + {hide-from-toc}[使用網站服務API驗證DDX檔案](/help/forms/developing/validate-ddx-document-using-web.md)
   + 疑難排解 {#troubleshooting}
      + [無法在某些版本的Oracle JDK中使用某些表單功能](/help/forms/using/unable-to-use-forms-features-with-certain-versions-of-oracle-jdk.md)
      + {hide-from-toc}[取得JEE版Adaptive Forms附件電子郵件的其他步驟](/help/forms/using/additional-steps-to-use-email-with-attachments.md)
      + {hide-from-toc}[無法在Windows Server上將Word或Excel檔案轉換成PDF](/help/forms/using/disable-uac-for-pdfgconfiguration.md)
      + {hide-from-toc}[無法在Google Chrome、Firefox、Microsoft Edge、Microsoft Internet Explorer或Apple Safari中開啟XFA型PDF forms](/help/forms/using/xfa-based-forms-in-chrome-firefox-ie-internet-explorter-safari-edge.md)
      + {hide-from-toc}[無法還原CRX存放庫](/help/forms/using/restore-crx-repository.md)
      + {hide-from-toc}[即使AEM Forms伺服器未完全啟動且執行中，仍要處理檔案](/help/forms/using/processing-documents-even-if-aem-forms-server-not-fully-up.md)
      + {hide-from-toc}[無法使用輸出服務、Forms服務或記錄檔案(DoR)服務](/help/forms/using/connection-issues-with-output-forms-and-document-of-record-dor-services.md)
      + {hide-from-toc}[PDF產生無法在WorkBench上列印大量PDF](/help/forms/using/pdf-generation-service-fails-to-print-a-large-number-of-pdfs-on-workbench.md)
      + {hide-from-toc}[如何正確重新啟動AEM SDK](/help/forms/using/restart-aem-sdk.md)
      ...
      + [緩解JEE 6.5 LTS SP2上AEM Forms的伺服器端請求偽造(SSRF)漏洞](/help/forms/using/mitigating-server-side-request-forgery-vulnerabilities-for-aem-forms-on-jee-65-lts-sp2.md)
   + 舊版檔案 {#legacy-documentation}
      ...
      + {hide-from-toc}[在JEE伺服器叢集上設定和疑難排解AEM Forms](/help/forms/developing/configure-server-cluster.md)
      + {hide-from-toc}[在動態PDF forms中產生及使用雜湊](/help/forms/developing/hashing-forms.md)
      + {hide-from-toc}[使用WS-Security標頭傳遞認證](/help/forms/developing/passing-credentials.md)
+ AEM 中的 AI {#ai-in-aem}
...
+ 實施 {#implementing}
   + 開發 {#developing}
      ...
      + Headless 體驗管理 {#headless}
         ...
         + Headless 歷程 {#journeys}
            + Headless 開發人員歷程 {#developer}
               + [了解 AEM 中的 Headless](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/overview.html)
               ...
               + [踏上使用 AEM Headless 初體驗之路](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/path-to-first-experience.html)
               + [如何將您的內容模型化為 AEM 內容模型](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/model-your-content.html)
               ...
               + [如何使用 Headless 應用程式](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/go-live.html)
               + [選擇性 - 如何使用 AEM 建立單頁應用程式](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/create-spa.html)
            + Headless 內容架構者歷程 {#architect}
               + [AEM Headless 內容架構者歷程概觀](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/architect/overview.html)
               ...
               + [了解 AEM Headless 內容模型基本知識](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/architect/basics.html)
               + [了解如何在 AEM 中建立內容片段模型](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/architect/model-structure.html)
         ...
         + 內容片段{#content-fragments}
            + [使用內容片段和 GraphQL 的 Headless 傳遞](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-graphql.html)
            ...
            + [預覽 - JSON 代表](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-json-preview.html)
         + 傳送API{#delivery-api}
            ...
            + [使用 GraphiQL IDE](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/graphiql-ide.html)
            + [持續性查詢](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/persisted-queries.html)
            ...
            + [針對內容片段之遠端 AEM GraphQL 查詢的驗證](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/graphql-authentication-content-fragments.html)
            + [包含內容片段的AEM GraphQL API — 範例內容和查詢](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/content-fragments-graphql-samples.html)
      ...
      + 擴充AEM {#extending-aem}
         ...
         + 擴充傳統UI{#extending-classic-ui}
            ...
            + [開發報表](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/platform/dev-reports.html)
      + 測試 {#testing}
         ...
         + [測試您的UI](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/components/hobbes.html)
      + 最佳做法 {#bestpractices}
         + [最佳實務概述](/help/sites-developing/best-practices.md)
         + [AEM開發指導方針與最佳作法](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/introduction/dev-guidelines-bestpractices.html)
         ...
         + [自訂名稱空間](/help/sites-developing/custom-namespaces.md)
   ...
   + 部署中 {#deploying}
      ...
      + 部署AEM {#deploying}
         ...
         + [AEM的離線重新索引](/help/sites-deploying/offline-reindexing.md)
      ...
      + 設定AEM {#configuring}
         ...
         + {hide-from-toc}[版本正在清除](/help/sites-deploying/version-purging.md)
      ...
      + 升級至AEM 6.5 LTS {#upgrading}
         ...
         + {hide-from-toc}[使用模式偵測器評估升級複雜性](/help/sites-deploying/pattern-detector.md)
         + [使用AEM Analyzer評估升級複雜性](/help/sites-deploying/aem-analyzer.md)
         + {hide-from-toc}[在AEM 6.5 LTS中的向下相容性](/help/sites-deploying/backward-compatibility.md)
         + [升級程式](/help/sites-deploying/upgrade-procedure.md)
         + [執行就地升級](/help/sites-deploying/in-place-upgrade.md)
         + {hide-from-toc}[延遲的內容移轉](/help/sites-deploying/lazy-content-migration.md)
         + {hide-from-toc}[使用CRX2Oak移轉工具](/help/sites-deploying/using-crx2oak.md)
         ...
         + {hide-from-toc}[正在升級自訂搜尋Forms](/help/sites-deploying/upgrading-custom-search-forms.md)
         + {hide-from-toc}[永續升級](/help/sites-deploying/sustainable-upgrades.md)
