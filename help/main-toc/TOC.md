...
source-git-commit: 5f768d52e71f60e7d1404709d0383104694908d1
workflow-type: tm+mt
...
+ Forms {#forms}
   ...
   + JEE上AEM Forms的管理員說明 {#administrator-help}
      ...
      + 連線到內容管理系統 {#connect-content-management-system}
         + [設定EMC Documentum®的聯結器](/help/forms/using/admin-help/configuring-connector-emc-documentum.md)
         + [設定® FileNet的聯結器](/help/forms/using/admin-help/configuring-connector-ibm-filenet.md)
         + [設定® Content Manager的聯結器](/help/forms/using/admin-help/configuring-connector-ibm-content-manager.md)
      ...
      + 設定SSL {#configure-ssl}
         ...
         + [為WebSphere®應用程式伺服器設定SSL](/help/forms/using/admin-help/configuring-ssl-websphere-application-server.md)
      ...
      + 維護AEM表單資料庫 {#maintain-aem-forms-database}
         + [DB2®資料庫：每週執行處理作業](/help/forms/using/admin-help/db2-database-running-process-weekly.md)
         + [Oracle資料庫最大開啟游標臨界值](/help/forms/using/admin-help/oracle-database-maximum-open-cursors.md)
         + [® DB2® database：執行命令以進行定期維護](/help/forms/using/admin-help/ibm-db2-database-running-commands.md)
      ...
      + 維護應用程式伺服器 {#manage-application-server}
         ...
         + [啟動和停止WebSphere®應用程式伺服器](/help/forms/using/admin-help/starting-stopping-websphere-application-server.md)
      + AEM Forms備份和復原 {#aem-forms-backup-recovery}
         + [備份和復原EMC Documentum®存放庫](/help/forms/using/admin-help/backing-recovering-emc-documentum-repository.md)
